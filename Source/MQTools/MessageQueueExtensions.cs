...
namespace MQTools
{
    public static class MessageQueueExtensions
    {
        ...
        public static long GetPrivateQueueCount(string queue)
        {
            return GetQueueCount(null, "private$", queue);
        }

        public static long GetPrivateQueueCount(string computerName, string queue)
        {
            return GetQueueCount(computerName, "private$", queue);
        }

        public static long GetQueueCount(string computerName, string queueType, string queue)
        {
